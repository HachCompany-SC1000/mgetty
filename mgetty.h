...
int	mdm_send_byte _PROTO(( char * send, int fd ));
int	mdm_Send_SMS _PROTO((char * Number, char *Text , int fd));
...
int	mdm_get_string _PROTO((char * send, int n, int fd, char **receive ));
void	mdm_lock_tty _PROTO((void));
void	mdm_release_tty _PROTO((void));
