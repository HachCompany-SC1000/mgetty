...
//                             NULL };
static char * def_init_chat_seq[] = { 	"",
					"\\dATH0&F0\\\\Q1&D0", "OK", //H0:Disconnect &F0: Manufacturer default \Q1: Software flow controll &D0: TA ignores status of DTR
					NULL };
...
// 			    "OK", NULL };
static char * def_force_init_chat_seq[] = { 	"",
			    			"\\d\\d\\d+++\\d\\d\\dATH0&F0\\\\Q1&D0", "OK", //H0:Disconnect &F0: Manufacturer default \Q1: Software flow controll &D0: TA ignores status of DTR
						NULL };
...
struct conf_data_mgetty c = {
	...
	{ "pin-chat", {0}, CT_CHAT, C_EMPTY },
	{ "cimi-chat", {0}, CT_CHAT, C_EMPTY },
	{ "provider-chat", {0}, CT_CHAT, C_EMPTY },
...
conf_data c_a[2];
    ...
    c.init_chat.flags = C_OVERRIDE; // 24.03.2009 ignoriere Settings von mgetty.config

    c.force_init_chat.d.p = (void *) def_force_init_chat_seq;
    //c.force_init_chat.flags = C_PRESET;
    c.force_init_chat.flags = C_OVERRIDE; // 24.03.2009 ignoriere Settings von mgetty.config
